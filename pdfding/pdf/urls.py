...
urlpatterns = [
    ...
    path('shared/<uuid:token>', pdf_views.ViewSharedPdf.as_view(), name='view_shared_pdf'),
    path('shared/<uuid:token>/serve', pdf_views.ServeSharedPdf.as_view(), name='serve_shared_pdf'),
    path('share/<identifier>', pdf_views.SharePdf.as_view(), name='share_pdf'),
    path('unshare/<identifier>', pdf_views.UnsharePdf.as_view(), name='unshare_pdf'),
