...
| [12-achatamento-cartografia-vetorial.md](12-achatamento-cartografia-vetorial.md) | O que é "achatar" um PDF vetorial pesado, por que o maior arquivo do acervo precisa disso, como escolher o DPI, o passo a passo com Ghostscript+img2pdf, o risco para anotações já salvas, e como achar outros candidatos no acervo | Ao decidir tratar um PDF de cartografia/desenho vetorial pesado que trava o viewer (Fase 4 de 11-desempenho-viewer.md) |
